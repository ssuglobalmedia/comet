...
export const batchPutUser = async function (infos: Array<User>): Promise<Array<User>> {
  ...
  if (infos.length > 25) throw new BadRequestError('Maximum amount of batch creation is 25');
...
export const batchDeleteUser = async function (ids: Array<string>): Promise<Array<string>> {
  ...
  if (ids.length > 25) throw new BadRequestError('Maximum amount of batch creation is 25');
